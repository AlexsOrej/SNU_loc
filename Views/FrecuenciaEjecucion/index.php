    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-9 text-center">
                <h4>ADMINISTRACIÓN DE FRECUENCIA DE EJECUCION DE CONTROL</h4>
            </div>
            <div class="col-md-3">
                <button title="Botón para registrar procesos" onclick="Add()" data-toggle="modal" href='#modal-id' class="neu pull-right"><i class="glyphicon glyphicon-plus"></i> Registrar frecuencia ejecucion</button>
            </div>
        </div>
    </div>
    <div class="body">
...
<script>
    function Add() {
        $.ajax({
            type: "POST",
            url: '?c=frecuenciaejecucion&a=add',
            // data: 'id=' + val,
        ...
        Swal.fire({
            ...
            .then((willDelete) => {
                if (willDelete.value) {
                    $.ajax({
                        type: "POST",
                        url: '?c=frecuenciaejecucion&a=delete',
                        data: 'id=' + val,
