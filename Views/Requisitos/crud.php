        ...
        <form method="post" name="formSeccion" id="formSeccion">
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <input id="seccionid" class="form-control" type="hidden" name="seccionid" value="<?= $_REQUEST['seccion_id'] ?>">
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    function enviarFormulario() {
        ...
        $.ajax({
            type: 'POST',
            url: '?c=requisitos&a=Registrar', // Reemplaza con la URL correcta de tu controlador
            data: formData,
            contentType: false,
            processData: false,
