        ...
        <form class="form-inline">
            <div class="row">
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center">
                    <button type="button" name="buscar" id="buscar" value="Buscar" class="btn btn-default"><i class="glyphicon glyphicon-search"></i> Buscar</button>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript">
    $('#buscar').on('click', function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "?c=informes&a=InformeResultadoPqrs",
            type: "GET",
            data: {
                desde: desde,
                hasta: hasta,
