<div class="responsive">
    <form action="?c=mantenimientos&a=ValiMant" method="post">        
        ...
        <input type="hidden" name="est_verificacion" value="verificacion">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-4 col-sm-4 col-md-12 col-lg-12 text-center">
                        <div class="form-group">
                            <div class="form-line">
                                <label for="">Proveedor: <strong><?= strtoupper($value->responsable_id) ?></strong></label>
                                       </div>
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <textarea type="" class="form-control" name="detalles" cols="4" rows="4" value="" readonly><?= $value->detalles ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-4 col-sm-4 col-md-6 col-lg-6">
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                <textarea type="" class="form-control" name="recomendacion" cols="4" rows="4" value=">" readonly><?= $value->recomendacion ?></textarea>
                            </div>
                        </div>
                    </div>
                    <?php if($value->est_ejecucion=='ejecucion' AND empty($value->est_verificacion) ):?>
                    <div class="col-xs-4 col-sm-4 col-md-12 col-lg-12">
                        <div class="form-group">
                            <div class="form-line">
                                <label for="">Verificación</label>
                                <textarea type="" class="form-control" name="verificacion" cols="4" rows="4" value=""><?=$value->verificacion ?></textarea>
                            </div>
                        </div>
                    </div>
