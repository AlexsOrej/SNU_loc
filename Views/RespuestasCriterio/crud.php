                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            <input type="text" id="respuesta" name="respuesta" value="<?php echo $nivel->respuesta?>" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
...
<script>
    ...
    $(document).ready(function() {
       ...
       $('#formCrud').submit(function(e) {
           ...
           var nombre = document.getElementById('respuesta').value;
           ...
           if(nombre == ""){
              $('#respuesta').css('border', '2px solid red');
              var isValid = false;
           }
           if(valor == ""){
               ...
               if(totalGeneral > 100){
                ...
                Swal.fire({
                   ...
                   title: "la suma del criterio "+valor+"% sobrepasa el limite por "+ diferencia+" que debe ser igual a 100%",
                    ...
                    $.ajax({
                   url: '?c=respuestascontrol&a=crud', // Cambia esto por la URL de tu controlador
                   type: 'POST',
                   data: form.serialize(),
