                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            <input type="text" id="nombre" name="nombre" value="<?php echo $tipo->nombre?>" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="form-line">
                            ...
                            <input type="text" id="descripcion" name="descripcion" value="<?php echo $tipo->descripcion ?>" class="form-control">
                        </div>
                    </div>
                </div>        
               
                <div class="col-md-12">
                    <input type="hidden" id="id" name="id" value="<?php echo $tipo->id ?>" class="form-control">
    ...
    $(document).ready(function() {
        ...
        $('#formCrud').submit(function(e) {
            ...
            if (!isValid) {
                ...
                $.ajax({
                    url: '?c=tipoejecucion&a=crud', // Cambia esto por la URL de tu controlador
                    type: 'POST',
                    data: form.serialize(),
