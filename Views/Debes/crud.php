        ...
        <form method="post" name="formSeccion" id="formSeccion">
            <div class="row">
                ...
                <div class="col-sm-12" id="nuevosInputsContainer">
                    ...
                    <div id="plantillaNuevosInputs">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group">
                                <div class="form-line">
                                    <label for="nuevoTitulo">Descripción</label>
                ...
                <div class="col-sm-12">
                    ...
                    <input id="requisitoid" class="form-control" type="hidden" name="requisitoid" value="<?= $_REQUEST['requisito_id'] ?>">
                </div>
            </div>
        </form>
    </div>
...
<script>
    ...
    function enviarFormulario() {
        ...
        $.ajax({
            type: 'POST',
            url: '?c=debes&a=Registrar', // Reemplaza con la URL correcta de tu controlador
            data: formData,
            contentType: false,
            processData: false,
