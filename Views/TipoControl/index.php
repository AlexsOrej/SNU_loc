    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-md-9 text-center">
                <h4>ADMINISTRACIÓN DE TIPOS DE RIESGO</h4>
            </div>
            <div class="col-md-3">
                <button title="Botón para registrar procesos" onclick="Add()" data-toggle="modal" href='#modal-id' class="neu pull-right"><i class="glyphicon glyphicon-plus"></i> Registrar tipos de riesgo</button>
            </div>
        </div>
    </div>
    <div class="body">
        ...
        <div class="panel panel-body">
            <table id="table" class="table table-bordered">
                ...
                <tbody>
                    ...
                    ?>
                    <?php foreach ($tipoRiesgo as $value) : ?>
                        <tr class="">
